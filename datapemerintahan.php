		...
		<body> <br><br><br><br><br><br><br><br><br><br>
			<div class="container">
				<div class="row">
					...
					<h3><b> STRUKTUR ORGANISASI <br>
						MASA JABATAN 2020-2024</b></h3></center><br><br>
					<img src="images/orga.jpg" width="100%" height="400">
					<ul class="nav nav-tabs tab-nav-right" role="tablist">
						<li role="presentation" class="active"><a href="#list" data-toggle="tab">LIST</a></li>
						<li role="presentation"><a href="#export" data-toggle="tab">EXPORT DATA</a></li>
					</ul>
					<div class="tab-content">
						...
						<table id="data-table" class="table table-bordered table-striped table-hover js-basic-example">
							...
							<tbody>
								...
								<tr>
									<td>WALUYO SEJATI</td>
									<td>kepala dusun 1</td>
									<td>bengkulu</td>
									<td>2020/03/29</td>
								</tr>
								<tr>
									<td>RINA YULIANA</td>
									<td>kepala dusun 2</td>
									<td>bengkulu</td>
									<td>2020/03/29</td>
								</tr>
								<tr>
									<td>YACUB</td>
									<td>kepala dusun 3</td>
									<td>bengkulu</td>
									<td>2020/03/29</td>
								</tr>
							</tbody>
